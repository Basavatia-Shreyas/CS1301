...
#Add your code here!
part_one = (can_afford and destination_is_safe) or (not can_afford and (educational_value or relatives_nearby) and destination_is_safe)

part_two = (is_international and have_passport and not afraid_to_fly) or (not is_international and (have_a_car or not afraid_to_fly))

part_three = (is_a_beach and is_warm) or (has_skiing and not is_warm) or (is_a_city and (is_off_peak or has_attraction))

print(part_one and part_two and part_three)
