...
go_class = exam or (not exam and sunny and ((sunblock and morning_classes) or night_classes) or (not exam and raining and rain_jacket) or (not exam and snowing and ((friends_are_going and fluffy_coat) or (snow_boots and fluffy_coat) or really_want_to_go)))
                    
print("True or false: I should go to class:", go_class)
