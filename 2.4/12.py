...
#Add your code here!
print("The sum is " + str(mystery_value_1 + mystery_value_2) + ", the difference is " + str(mystery_value_1 - mystery_value_2) + ", the product is " + str(mystery_value_1 * mystery_value_2) + ", and the quotient is " + str(mystery_value_1 / mystery_value_2) + ".")
