...
if(phase == "Full"):
    if (distance < 230000 and (date >= 29 and date <= 31) and eclipse):
        print("Super Blue Blood Moon")
    elif(distance < 230000 and (date >= 29 and date <= 31)):
        print("Super Blue Moon")
    elif((date >= 29 and date <= 31) and eclipse):
        print("Blue Blood Moon")
    elif(distance < 230000 and eclipse):
        print("Super Blood Moon")
    elif (distance < 230000):
        print("Super Moon")
    elif(date >= 29 and date <= 31):
        print("Blue Moon")
    elif(eclipse):
        print("Blood Moon")
    else:
