...
def is_a_contender(a_string, wins, losses):
    if (wins >= 40 and losses < 20):
        return ("The " + a_string + " are a contender!")
    elif(wins < 40 and losses >= 20):
        return ("The " + a_string + " are not a contender!")
    else:
        return ("The " + a_string + " might be a contender!")
