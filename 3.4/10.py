...
#Add your code here!
def what_season(a_string, a_day):
    if a_string in "AprilMay" or (a_string == "March" and a_day >= 20) or (a_string == "June" and a_day <= 20):
        return "Spring"
    elif a_string in "JulyAugust" or (a_string == "June" and a_day >= 21) or (a_string == "September" and a_day <= 21):
        return "Summer"
    elif a_string in "OctoberNovember" or (a_string == "September" and a_day >= 22) or (a_string == "December" and a_day <= 20):
        return "Fall"
    else:
        return "Winter"
