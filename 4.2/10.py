...
def to_ordinal(an_int):
    if (an_int % 10 == 1 and an_int != 11):
        return str(an_int) + "st"
    elif (an_int % 10 == 2 and an_int != 12):
        return str(an_int) + "nd"
    elif (an_int % 10 == 3 and an_int != 13):
        return str(an_int) + "rd"
    else:
        return str(an_int) + "th"
